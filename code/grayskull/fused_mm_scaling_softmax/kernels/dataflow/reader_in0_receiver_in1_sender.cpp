/*
 * Kernel receiving tiles of the first input matrix from other cores and reading tiles of the second input matrix from
 * the card's DRAM (and broadcast).
 ...
 * https://github.com/tenstorrent/tt-metal/blob/e85e46876d0818ab787b1290884be743fbf2366e/tt_metal/programming_examples/matmul_common/kernels/dataflow/reader_bmm_tile_layout_in0_receiver_in1_sender.cpp
...
void kernel_main() {
    ...
    const uint32_t tile_size = get_tile_size(in1_cb);
    const DataFormat data_format = get_dataformat(in1_cb);
